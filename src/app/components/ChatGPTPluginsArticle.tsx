...
export default function ChatGPTPluginsArticle() {
  return (
    <article className="max-w-3xl mx-auto">
      ...
      <p className="text-[#59657d] leading-relaxed mb-5">In modern ChatGPT interfaces, older “plugins” terminology may appear as apps, connectors, actions, or integrations. The exact labels and available capabilities depend on the account and service you are using. The principle is the same: ChatGPT can work with an external service only through a connection that is available and authorised.</p>
